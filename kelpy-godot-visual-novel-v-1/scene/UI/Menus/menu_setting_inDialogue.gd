...
@onready var buttons = [
	$Options/Buttons/Control,
	$Options/Buttons/Audio,
	$Options/Buttons/Graphic,
	$Options/Buttons/Back
]

@onready var buttons_sprite = [
	$Options/Sprites/Control,
	$Options/Sprites/Audio,
	$Options/Sprites/Graphic,
...
func _on_control_pressed() -> void:
	_menu_pausing_toggle(true)
	$Options/Menus/Control_inDialogue._menu_pausing_toggle(false)


func _on_audio_pressed() -> void:
	_menu_pausing_toggle(true)
	$Options/Menus/Audio_inDialogue._menu_pausing_toggle(false)


func _on_graphic_pressed() -> void:
	_menu_pausing_toggle(true)
	$Options/Menus/Graphic_inDialogue._menu_pausing_toggle(false)
...
func _on_dialogue_text_pressed() -> void:
	_menu_pausing_toggle(true)
	$Options/Menus/Dialogue_Setting_inDialogue._menu_pausing_toggle(false)
