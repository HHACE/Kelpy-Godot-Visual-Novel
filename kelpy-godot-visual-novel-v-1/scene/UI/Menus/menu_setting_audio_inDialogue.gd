...
func save_volume():
	...
	var file = FileAccess.open("user://user_settings/setting_volumns.json", FileAccess.WRITE)
...
func load_volume():
	if FileAccess.file_exists("user://user_settings/setting_volumns.json"):
		var file = FileAccess.open("user://user_settings/setting_volumns.json", FileAccess.READ)
...
func _on_bus_master_progress_bar_value_changed(value: float) -> void:
	set_master_volume(vol_bus_master,  $Options/Buttons/Bus_master/ProgressBar.value)


func _on_bus_music_progress_bar_value_changed(value: float) -> void:
	set_master_volume(vol_bus_music, $Options/Buttons/Bus_music/ProgressBar.value)


func _on_bus_efx_progress_bar_value_changed(value: float) -> void:
	set_master_volume(vol_bus_sfx, $Options/Buttons/Bus_efx/ProgressBar.value)


func _on_bus_voice_progress_bar_value_changed(value: float) -> void:
	set_master_volume(vol_bus_voice, $Options/Buttons/Bus_voice/ProgressBar.value)
